  ...
  Object.values(positions).forEach((position) => {
    switch (position.length) {
      ...
      case 4:
        ...
        break
      case 5:
        position[0].position.x += 50
        position[1].position.x -= 50
        position[2].position.x += 20
        position[2].position.y -= 30
        position[3].position.y += 25
        position[4].position.x -= 20
        position[4].position.y -= 30
        position.forEach((character) => resultCharacters.push(character))
        break
      case 6:
        position[0].position.x += 0.2
